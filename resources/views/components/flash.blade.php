...
@if (session('error'))
<div class="fixed top-4 right-4 z-50">
    <div class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 shadow-lg rounded-lg" role="alert">
        <div class="flex items-center">
            <div class="py-1">
...
@if ($errors->any())
<div class="fixed top-4 right-4 z-50">
    <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 shadow-lg rounded-lg" role="alert">
        <div class="flex items-center">
            <div class="py-1">
